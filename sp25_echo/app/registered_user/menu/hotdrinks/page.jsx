...
export default function HotDrinks() {
    ...
    const [hot_drinks, setHotDrinks] = useState([])
    ...
    const addItemToCart = () => {
        ...
        addToCart(cartItem)
        // alert(`${selectedItem.name} (${selectedSize.size}) added to cart!`)
        closePopUp()
    }
    ...
    return (
        ...
        >
            ...
            {hot_drinks.length > 0 ? (
                    ...
                    <div className="menu-grid">
                        <AnimatePresence>
                            {hot_drinks.map((item, index) => (
                                ...
                                >
                                    <HotDrinksCards hot_drinks={item} />
                                </motion.div>
                            ))}
                        </AnimatePresence>
                    </div>
                ...
                <p className="no-drinks-found-error text-center">No hot drinks found.</p>
            )}
