...
export default function IcedDrinks() {
    ...
    const [iced_drinks, setIcedDrinks] = useState([])
    ...
    useEffect(() => {
        ...
        const fetchIcedDrinks = async () => {
            ...
            setIcedDrinks(drinksWithPrices)
            setFetchError(null)
    ...
    return (
        ...
        >
            ...
            {iced_drinks.length > 0 ? (
                <div className="menu">
                    <div className="menu-grid">
                        <AnimatePresence>
                            {iced_drinks.map((item, index) => (
                                <motion.div
                                    key={item.id}
                                ...
                                >
                                    <IcedDrinksCards iced_drinks={item} />
                                </motion.div>
                            ))}
                        </AnimatePresence>
                    </div>
                ...
                <p className="no-drinks-found-error text-center">No iced drinks found.</p>
            )}
